...
import { parseHasChildren } from '../lib/utils';
                                ...
                                {filtered.length === 0 ? (
                                    ...
                                    filtered.map(person => (
                                        <tr key={person.id} className="border-b border-gray-100 hover:bg-slate-50/50 transition">
                                            ...
                                            {/* Children status */}
                                            <td className="p-4 text-xs font-semibold text-gray-600">
                                                {parseHasChildren(person.hasChildren) ? (
                                            ...
                                            <td className="p-4 text-right">
                                                <div className="flex items-center justify-end gap-2">
                                                    <button 
                                                        ...
                                                        className="text-indigo-600 hover:text-indigo-850 hover:underline font-bold text-2xs bg-indigo-50 hover:bg-indigo-100/50 px-2.5 py-1.5 rounded-lg transition"
                                                    >
                                                        Voir Profil
                                                    </button>
                                                    <button 
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8 max-w-lg w-full animate-fadeIn flex flex-col max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="space-y-4 flex-1">
                            ...
                            <div className="bg-slate-50 border border-gray-150 p-4 rounded-xl space-y-3 shadow-3xs">
                                <h4 className="text-2xs font-black text-gray-400 uppercase tracking-wide border-b border-gray-200 pb-1.5">📁 Informations Administratives</h4>
                                <div className="grid grid-cols-2 gap-3 text-xs">
                                    ...
                                    <div>
                                        ...
                                        <span className="font-bold text-gray-700 block mt-1">
                                            ...
                                            {parseHasChildren(selectedPersonnel.hasChildren) ? ` (${selectedPersonnel.childrenCount} enf.)` : ''}
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="border border-amber-200/60 p-4 rounded-xl space-y-2.5 bg-amber-50/15 shadow-3xs">
                                <h4 className="text-2xs font-black text-amber-800 uppercase tracking-wide border-b border-amber-200/50 pb-1.5 flex items-center gap-1.5">
                                    ⚠️ Mesure Disciplinaire & Sanction
                                </h4>
                            ...
                            <div className="border border-gray-150 p-4 rounded-xl space-y-3 bg-white shadow-3xs">
                                <h4 className="text-2xs font-black text-gray-400 uppercase tracking-wide border-b border-gray-150 pb-1.5">📞 Canaux de contact Direct</h4>
                                <div className="space-y-3.5 text-xs">
                                    ...
                                    <div className="flex items-center gap-2.5">
                                        ...
                                        <div>
                                            ...
                                            <a href={`mailto:${selectedPersonnel.email}`} className="font-bold text-[#15447c] hover:underline text-xs">{selectedPersonnel.email}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
