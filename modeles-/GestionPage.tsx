...
import { parseHasChildren, toHasChildrenLabel } from '../lib/utils';
                                        ...
                                        {isEditing ? (
                                                ...
                                                <td className={tableCellClass}>
                                                    <div className="space-y-1.5">
                                                        ...
                                                        <div className="flex gap-1">
                                                            <select 
                                                                value={toHasChildrenLabel(editForm.hasChildren)} 
                                                            ...
                                                            {toHasChildrenLabel(editForm.hasChildren) === 'Oui' && (
                                                                <input 
                                                                    type="number" 
                                            ...
                                            <>
                                                ...
                                                <td className={`${tableCellClass} font-semibold text-slate-650`}>
                                                    {item.maritalStatus} {parseHasChildren(item.hasChildren) ? `(${item.childrenCount} enfants)` : '(Sans enfants)'}
                                                </td>
                                                <td className={tableCellClass}>
                                                    <span className={`px-2 py-0.5 rounded text-[10px] font-bold ${
