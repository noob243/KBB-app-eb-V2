                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <select 
                                    ...
                                    className="w-full p-2 border border-gray-300 rounded-md shadow-sm bg-white focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 focus:outline-hidden"
                                >
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-indigo-50/30 p-4 rounded-xl border border-indigo-100/60 space-y-3.5 mt-2">
                                <div className="flex justify-between items-center pb-2 border-b border-indigo-100/30">
                                    <span className="text-[10px] font-black text-[#15447c] uppercase tracking-wider block">Adresses Sociales Additionnelles</span>
