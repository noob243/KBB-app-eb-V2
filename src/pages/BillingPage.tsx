...
const BillingPage: FC<BillingPageProps> = ({ invoices, cases, onAddInvoice }) => {
    ...
    const filteredInvoices = invoices.filter(invoice => {
        ...
        const searchTarget = `${invoice.id} ${invoice.status} ${invoice.dueDate} ${relatedCase ? relatedCase.name : ''}`.toLowerCase();
